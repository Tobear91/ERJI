...
class Doctrine
{
    ...
    public function __construct()
    {
        ...
        // Auto-scan des entités
        $moduleBasePath = __DIR__ . '/../../Module';
        $paths = [];

        foreach (scandir($moduleBasePath) as $moduleDir) {
            $entityPath = "$moduleBasePath/$moduleDir/Infrastructure/Doctrine/Entity";
